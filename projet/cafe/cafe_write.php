<?php
    ...
    $sql = "select * from catecory where curl = '{$curl}'";
    $go = $db -> prepare($sql);
    $go ->execute();
?>
<!DOCTYPE html>
...
<body>
    <div id="wrap">
        ...
        <section>
            <article class="board">
                <form action="board_insert.php?curl=<?=$curl?>" method="post">
                    <table class="tb">
                      <tr>
                      ...
                      <tr>
                          <td colspan="3"><textarea name="content" id="content" cols="80" rows="30" style="resize:none" placeholder="CONTENT"></textarea></td>
                      </tr>
                    </table>
                </form>
            </article>
